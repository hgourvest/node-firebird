        ...
        function putBlobData(index, value, callback) {
            ...
            self.createBlob2(transaction, function(err, blob) {
                ...
                if (Buffer.isBuffer(value))
					...
					//
					// ARD INFORMATIQUE
					// INTEGER_LIST en entrée de PS,
					// QUAND ON PASSE UN ARRAY ET QUE LA PS ATTEND UN BLOB ALORS
					// ON CONVERTIT L'ARRAY EN CHAINE DE CARACTERE
					//
					b = new Buffer(value.toString(), DEFAULT_ENCODING)
                else if (!isStream)
