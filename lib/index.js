...
exports.escape = function(val) {
    ...
    if (val instanceof Date)
        return "'" + val.getFullYear() + '-' + val.getMonth().toString().padLeft(2, '0') + '-' + val.getDate().toString().padLeft(2, '0') + ' ' + val.getHours().toString().padLeft(2, '0') + ':' + val.getMinutes().toString().padLeft(2, '0') + ':' + val.getSeconds().toString().padLeft(2, '0') + "'";
...
Database.prototype.query = function(query, params, callback) {
    ...
    this.execute(query, params, mapFieldNames(callback, this));
};
