        ...
        function putBlobData(index, value, callback) {
            ...
            self.createBlob2(transaction, function(err, blob) {
                ...
                if (Buffer.isBuffer(value))
                    ...
                    b = Buffer.from(value, this._charset);
                else if (!isStream)
                    b = Buffer.from(JSON.stringify(value), this._charset);
        ...
        for (var i = 0, length = params.length; i < length; i++) {
            ...
            if (value === null || value === undefined) {
                switch (meta.type) {
                    ...
                    case Const.SQL_NULL:
                    case Const.SQL_TEXT:
                        ret[i] = new Xsql.SQLParamString(null, this._charset);
                        break;
                    ...
                    default:
                        switch (typeof value) {
                            ...
                            case 'number':
                                ...
                                break;
                            case 'string':
                                ret[i] = new Xsql.SQLParamString(value, this._charset);
                                break;
                            case 'boolean':
                            ...
                            default:
                                ...
                                ret[i] = new Xsql.SQLParamString(value.toString(), this._charset);
                                break;
                        }
                        done();
                }
