...
class Connection {
    ...
    allocateAndPrepareStatement(transaction, query, plan, callback) {
        ...
        // Use the schema-aware DESCRIBE variant on Protocol 20+ (Firebird 6.0)
        // so that isc_info_sql_relation_schema is returned for each column.
        const describeBytes = this.accept.protocolVersion >= Const.PROTOCOL_VERSION20
