    ...
    while (br.pos < br.buffer.length) {
        ...
        switch (outerTag) {
                ...
                while (!finishDescribe){
                    ...
                    switch (innerTag) {
                        ...
                        case Const.isc_info_sql_type:
                            ...
                            switch (type&~1) {
                                ...
                                case Const.SQL_DEC16:
                                    param = new Xsql.SQLVarDouble(); // Fallback
                                    break;
                        ...
                        case Const.isc_info_sql_length:
                            ...
                            console.log('DEBUG: Field type:', param.type, 'length:', param.length);
            ...
            default:
                ...
                console.log('DEBUG: Unknown outer tag in describe:', outerTag);
