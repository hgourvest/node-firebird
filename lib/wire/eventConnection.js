        ...
        self._socket.on('data', function (data) {
            ...
            try {
                ...
                while (xdr.pos < xdr.buffer.length) {
                    ...
                    switch (r) {
                        case Const.op_event:
                            ...
                            console.error('[DBG:eventConn] op_event received: event_id=%d lst_event=%j hasCb=%s',
                                event_id, lst_event, self.eventcallback ? 'yes' : 'no');
                ...
                if (err instanceof RangeError) { // incomplete packet case
                    ...
                    console.error('[DBG:eventConn] unexpected error processing op_event:', err);
                }
            }
        })
    }
