...
class ServiceManager extends Events.EventEmitter {
    ...
    _processcapabilities(blr, res) {
        ...
        var dbcapa = res[_infosmapping[57]] = [];
    ...
    _processdbinfo(blr, res) {
        ...
        var dbinfo = res[_infosmapping[50]] = {};
        ...
        for (; tinfo !== Const.isc_info_end; tinfo = br.readByteCode()) {
            switch (tinfo) {
                ...
                case Const.isc_info_svc_get_env_msg:
                    res[_infosmapping[tinfo]] = br.readString();
                    break;
                case Const.isc_info_svc_version:
                    res[_infosmapping[tinfo]] = br.readInt32();
                    break;
                ...
                case Const.isc_info_svc_get_users:
                    br.pos += 2
                    res[_infosmapping[tinfo]] = [];
                    break;
                case Const.isc_spb_sec_username:
                    var tuser = res[_infosmapping[68]];
                    tuser.push({});
