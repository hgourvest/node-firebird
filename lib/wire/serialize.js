...
class XdrWriter {
    ...
    addDecFloat16(value) {
        ...
        // For now, we store as raw bytes. Full IEEE 754 Decimal encoding would require a library.
        // This is a placeholder that writes the value as a buffer
        this.ensure(8);
        
        if (Buffer.isBuffer(value)) {
            // If already encoded as buffer, write directly
            value.copy(this.buffer, this.pos, 0, 8);
        } else {
            // Convert numeric value to buffer - simplified implementation
            // In production, this should use proper IEEE 754 Decimal64 encoding
    ...
    addDecFloat34(value) {
        ...
        if (Buffer.isBuffer(value)) {
            ...
            // Convert numeric value to buffer - simplified implementation
            // In production, this should use proper IEEE 754 Decimal128 encoding
...
class XdrReader {
    ...
    readDecFloat16() {
        // DECFLOAT(16) - IEEE 754 Decimal64 - 8 bytes
        // For now, return as buffer for proper handling by application
        // Full IEEE 754 Decimal decoding would require a library
        const buf = this.buffer.slice(this.pos, this.pos + 8);
        this.pos += 8;
        
        // Simplified decoding - return as number
        // In production, this should use proper IEEE 754 Decimal64 decoding
        try {
    ...
    readDecFloat34() {
        ...
        // Simplified decoding - return as string to preserve precision
        // In production, this should use proper IEEE 754 Decimal128 decoding
        try {
