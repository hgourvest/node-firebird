...
| Next minor | Result metadata + affected rows (`withMeta`, #13) ✅ done; server `warning` events (#15) ✅ done; tagged-template query API (#14) ✅ done; savepoint helpers (#16) ✅ done; env-var config defaults (#17) ✅ done; pool recycling (`maxUses`/`maxLifetimeMillis`, #18) ✅ done; row-key transforms (`transformKeys`, #19) ✅ done |
