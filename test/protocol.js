...
describe('Test Firebird 3.0 protocol support', function () {
    it('should define protocol versions 14 and 15', function (done) {
    ...
    it('should include protocols 14 and 15 in SUPPORTED_PROTOCOL', function (done) {
    ...
    it('should support Srp256 authentication plugin', function (done) {
    ...
    it('should prefer Srp256 over Srp', function (done) {
    ...
    it('should export AUTH_PLUGIN_SRP256 from main module', function (done) {
        assert.strictEqual(Firebird.AUTH_PLUGIN_SRP256, 'Srp256');
        done();
    });

    it('should export wire crypt constants', function (done) {
        assert.strictEqual(Firebird.WIRE_CRYPT_ENABLE, 1);
        assert.strictEqual(Firebird.WIRE_CRYPT_DISABLE, 0);
        done();
    });

    it('should define op_crypt opcode', function (done) {
